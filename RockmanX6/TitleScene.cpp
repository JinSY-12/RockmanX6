...
void TitleScene::addImage(void)
{
	...
	//// 배경 스테이지 ////
	// 인트로 스테이지
	IMAGEMANAGER->addImage("Stage_Intro", "Resources/Image/Stage/Stage_Intro.bmp", 6415 * SCALE_FACTOR, 970 * SCALE_FACTOR, true, MAGENTA);
	IMAGEMANAGER->addImage("Pixel_Intro", "Resources/Image/Stage/Pixel/Stage_Intro_Pixel.bmp", 6415 * SCALE_FACTOR, 970 * SCALE_FACTOR, true, MAGENTA);

	IMAGEMANAGER->addImage("Stage_Object1", "Resources/Image/Stage/Stage_Object1.bmp", 152 * SCALE_FACTOR, 105 * SCALE_FACTOR, true, MAGENTA);
	IMAGEMANAGER->addImage("Stage_Object2", "Resources/Image/Stage/Stage_Object2.bmp", 64 * SCALE_FACTOR, 80 * SCALE_FACTOR, true, MAGENTA);
	...
	IMAGEMANAGER->addFrameImage("X_DashEnd", "Resources/Image/Player/X/X_DashEnd.bmp", 264 * SCALE_FACTOR, 88 * SCALE_FACTOR, 4, 2, true, MAGENTA, true);
	IMAGEMANAGER->addFrameImage("X_DashEndBurst", "Resources/Image/Player/X/X_DashEndBurst.bmp", 264 * SCALE_FACTOR, 88 * SCALE_FACTOR, 4, 2, true, MAGENTA, true);
	...
	IMAGEMANAGER->addFrameImage("X_LadderStart", "Resources/Image/Player/X/X_LadderStart.bmp", 102 * SCALE_FACTOR, 134 * SCALE_FACTOR, 3, 2, true, MAGENTA, true);
	...
	IMAGEMANAGER->addFrameImage("X_LadderEnd", "Resources/Image/Player/X/X_LadderEnd.bmp", 102 * SCALE_FACTOR, 134 * SCALE_FACTOR, 3, 2, true, MAGENTA, true);
